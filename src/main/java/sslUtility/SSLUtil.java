...
public class SSLUtil {
    public static SSLContext createSSLContext(String keystorePassword, String truststorePassword) throws Exception {
        // load the keystore which stores the private key and public cert
        KeyStore keyStore = KeyStore.getInstance("PKCS12");
        try (FileInputStream fis = new FileInputStream(System.getProperty("user.dir") + "/certs/client/client-keystore.p12")) {
